...
```text
https://meet.freiza.cloud/static/auto-record/?room=ROOM_NAME
```

Example:

```text
https://meet.freiza.cloud/static/auto-record/?room=client-session
```
...
1. Open `https://meet.freiza.cloud/static/auto-record/?room=test`.
2. Log in as `admin`.
